  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    {
      id: "welcome",
      from: "bot",
      text: `မင်္ဂလာပါ ${currentUser?.name?.split(" ")[0] ?? ""}! ကျွန်တော်က **OFM AI Data Assistant** ပါ။ သင့်ရဲ့ Task နှင့် ခွင့်ဆိုင်ရာ အချက်အလက်များကို မြန်မာဘာသာဖြင့် အကျဉ်းချုပ် တင်ပြပေးနိုင်ပါတယ်။ အောက်က အကြံပြုချက်များကို နှိပ်၍ဖြစ်စေ၊ မိမိဘာသာ မေးမြန်း၍ဖြစ်စေ စတင်နိုင်ပါတယ်။`,
    },
  ]);
